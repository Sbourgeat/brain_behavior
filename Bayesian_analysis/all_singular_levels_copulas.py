"""
This script estimates the copula of the 3 levels of the brain's hierarchical model.
The copula is the used to estimate the correlation between the brain morphology and behaviour.
"""
